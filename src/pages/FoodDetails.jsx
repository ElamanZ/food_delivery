              ...
              {tab === "desc" ? (
                ...
                <div className="tab__form mb-3">
                  <div className="review pt-5">
                    <p className="user__name mb-0">Erwin Smith</p>
                    <p className="user__email">s.erwin@gmail.com</p>
                  ...
                  <div className="review">
                    <p className="user__name mb-0">Levi Ackerman</p>
                    <p className="user__email">a.levi@gmail.com</p>
                    <p className="feedback__text">Great product</p>
                  </div>

                  <div className="review">
                    <p className="user__name mb-0">Hange Zoë</p>
                    <p className="user__email">z.hange@gmail.com</p>
                    <p className="feedback__text">Great product</p>
                  </div>
                  <form className="form">
